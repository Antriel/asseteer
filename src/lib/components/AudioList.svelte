...
<div class="flex flex-col gap-4 p-4">
  ...
  {#if selectedAsset}
    <div class="sticky top-0 z-10 p-4 bg-primary border border-default rounded-lg shadow-lg">
  ...
  {:else}
    <div class="p-6 bg-secondary border border-default rounded-lg text-center text-secondary">
  ...
  <div class="flex flex-col gap-2">
    {#each assets as asset (asset.id)}
      <button
        class="flex items-center gap-4 p-4 bg-secondary border border-default rounded-lg transition-all hover:border-accent cursor-pointer text-left"
