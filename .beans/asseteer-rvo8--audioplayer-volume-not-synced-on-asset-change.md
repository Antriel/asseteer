...
updated_at: 2026-03-16T14:58:32Z
...
Added `audioElement.volume = volume` in `handleLoadedMetadata()` so that when a new audio asset loads, the audio element inherits the user's current volume setting instead of defaulting to 1.0.
